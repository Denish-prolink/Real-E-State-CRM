...
export const createProduct = async (payload: IProductPayload & { agencyId: string }) => {
  return Product.create(payload);
};

export const findProductByBarcode = async (barcode: string, agencyId: string) => {
  if (!barcode) {
    return null;
  }
...
export const countProducts = async (agencyId: string, search?: string) => {
  return Product.countDocuments(buildFilter(agencyId, search));
};

export const findProductById = async (id: string, agencyId: string) => {
...
export const deleteProduct = async (id: string, agencyId: string) => {
