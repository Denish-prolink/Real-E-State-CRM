...
export const createSupplier = async (payload: ISupplierPayload & { agencyId: string | undefined }) => {
  return Supplier.create(payload);
};

export const findSupplierByCode = async (code: string, agencyId: string | undefined) => {
...
export const countSuppliers = async (agencyId: string | undefined, search?: string) => {
  return Supplier.countDocuments(buildFilter(agencyId, search));
};

export const findSupplierById = async (id: string, agencyId: string | undefined) => {
...
export const deleteSupplier = async (id: string, agencyId: string | undefined) => {
