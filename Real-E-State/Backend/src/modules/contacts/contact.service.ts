...
export const createContact = async (data: Partial<IContact> & { agencyId: string | undefined }) => {
...
export const getContactById = async (id: string, agencyId: string | undefined) => {
...
export const updateContact = async (id: string, data: Partial<IContact>, agencyId: string | undefined) => {
...
export const deleteContact = async (id: string, agencyId: string | undefined) => {
