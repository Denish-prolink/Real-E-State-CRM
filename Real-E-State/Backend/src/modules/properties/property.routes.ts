...
router.post('/', upload.array('photos', 10), validate(createPropertySchema), controller.createProperty);
router.get('/', controller.getProperties);
router.get('/:id', controller.getPropertyById);
router.put('/:id', upload.array('photos', 10), validate(updatePropertySchema), controller.updateProperty);
