...
export const createSiteVisitService = async (agencyId: string | undefined, data: Partial<ISiteVisit>) => {
  return repository.createSiteVisit({ ...data, agencyId: agencyId as any });
};

export const getSiteVisitsService = async (agencyId: string | undefined, filters: any = {}) => {
  return repository.findSiteVisitsByCompany(agencyId, filters);
};

export const getSiteVisitByIdService = async (id: string, agencyId: string | undefined) => {
...
export const updateSiteVisitService = async (id: string, agencyId: string | undefined, data: Partial<ISiteVisit>) => {
...
export const deleteSiteVisitService = async (id: string, agencyId: string | undefined) => {
